...
public class OrigenesBD extends SQLiteOpenHelper {
    ...
    public void agregarProductos(SQLiteDatabase db) {
        ...
        insertarProducto(db, "Omega 3", "Suplemento de aceite de pescado.", "25.564", 1, R.drawable.omega3);
        insertarProducto(db, "Melatonina", "Suplemento para dormir.", "41.341", 1, R.drawable.melatonina);
        // Insertar productos herbales
        insertarProducto(db, "Té Verde", "Bebida de hojas de té verde.", "15.321", 2, R.drawable.te_verde);
        // Insertar productos vitaminas
        insertarProducto(db, "Vitamina C", "Suplemento de vitamina C.", "10.556", 3, R.drawable.vitamina_c);
        // Insertar productos minerales
        insertarProducto(db, "Calcio", "El calcio es la principal fuente de minerales para los huesos", "20.564", 4, R.drawable.calcio);
